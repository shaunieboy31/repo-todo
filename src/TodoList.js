  ...
  return (
    <div className="min-h-screen bg-pink-50 flex flex-col items-center p-8 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
        {/* To Do Section */}
        <div className="bg-pink-200 rounded-2xl p-6 shadow-lg col-span-1 md:col-span-2">
        ...
        {/* Remember Section */}
        <div className="bg-green-300 rounded-xl p-4 shadow-md col-span-full md:col-span-2 lg:col-span-1">
